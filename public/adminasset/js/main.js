...
function delette(thing) {
  Swal.fire({
  title: 'Are you sure?',
  text: "You won't be able to get  back "+thing+"!",
  type: 'warning',
...
function deleteproduct(thing, id) {
  Swal.fire({
  title: 'Are you sure?',
  text: "You won't be able to delete "+thing+"!",
  type: 'warning',
...
$('#uploadThree .upload').on('change', function(e){
  console.log(e);
  readURL(this, '#uploadThree img');
})

$('#uploadFour .upload').on('change', function(e){
  console.log(e);
  readURL(this, '#uploadFour img');
})

$('#uploadLogo .upload').on('change', function(e){
  console.log(e);
  readURL(this, '#uploadLogo img');
})

$('#uploadHome .upload').on('change', function(e){
  console.log(e);
  readURL(this, '#uploadHome img');
})
...
$(document).ready(function() {
  ...
  toolbar: "styleselect fontselect fontsizeselect | forecolor backcolor", menubar:false,
  statusbar: false,
  plugins: "textcolor"});
...
/******************* */
/*to add style to nav li  */
$(".nav-tabs li ").click(function(){
  $(".nav-tabs li").removeClass("test");
  $(this).addClass("test");
});