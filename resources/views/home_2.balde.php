...
<body class="goto-here" style="padding:0px">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light">
		<a href="#" class="" style="margin:0px 3% 0px 3%"><img src="{{ asset('webasset/images/time-logo.png')}}" style="max-width:100px" /></a>
	...
	<div id="wowslider-container1">
		...
		<div class="ws_images">
			<ul>
				...
				<li><a href="www.google.com" target="_blank"><img src="{{ asset('webasset/data1/images/peopleinsidebuilding2610756.jp')}}g" alt="Brand - Cairo Mall - Floor 3 - B 7" title="Brand - Cairo Mall - Floor 3 - B 7" id="wows1_2" /></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 mb-5 ftco-animate">
					<img src="{{ asset('webasset/images/shop/offer-1.jpg')}}" class="img-fluid" alt="Colorlib Template">
				</div>
				<div class="col-lg-4 mb-5 ftco-animate">
					<div style="margin-bottom:20px">
						<img src="{{ asset('webasset/images/shop/offer-2.jpg')}}" class="img-fluid" alt="Colorlib Template">
					</div>
					<div style="margin-top:20px">
						<img src="{{ asset('webasset/images/shop/offer-3.jpg')}}" class="img-fluid" alt="Colorlib Template">
					</div>
				</div>
			</div>
		</div>
					...
					<div id="coverflow">
						<ul class="flip-items">
							<li data-flip-title="Red">
								<img src="{{ asset('webasset/images/gl1.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Razzmatazz" data-flip-category="Purples">
								<img src="{{ asset('webasset/images/gl2.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Deep Lilac" data-flip-category="Purples">
								<img src="{{ asset('webasset/images/gl3.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Daisy Bush" data-flip-category="Purples">
								<img src="{{ asset('webasset/images/gl4.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Cerulean Blue" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl5.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Dodger Blue" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl6.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Cyan" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl7.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Robin's Egg" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl8.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Deep Sea" data-flip-category="Greens">
								<img src="{{ asset('webasset/images/gl9.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Apple" data-flip-category="Greens">
								<img src="{{ asset('webasset/images/gl10.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Red">
								<img src="{{ asset('webasset/images/gl11.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Razzmatazz" data-flip-category="Purples">
								<img src="{{ asset('webasset/images/gl12.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Deep Lilac" data-flip-category="Purples">
								<img src="{{ asset('webasset/images/gl13.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Daisy Bush" data-flip-category="Purples">
								<img src="{{ asset('webasset/images/gl14.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Cerulean Blue" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl15.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Dodger Blue" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl16.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Cyan" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl17.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Robin's Egg" data-flip-category="Blues">
								<img src="{{ asset('webasset/images/gl18.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Deep Sea" data-flip-category="Greens">
								<img src="{{ asset('webasset/images/gl19.jpg')}}" style="width:350px ; height:350px">
							</li>
							<li data-flip-title="Apple" data-flip-category="Greens">
								<img src="{{ asset('webasset/images/gl20.jpg')}}" style="width:350px ; height:350px">
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-1.jpg')}}" alt="Colorlib Template">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-2.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="#">Strawberry</a></h3><br />
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-3.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-4.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-5.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="#">Strawberry</a></h3><br />
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-6.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-7.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-8.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-9.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="#">Strawberry</a></h3><br />
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-10.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-11.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod">
							<img class="img-fluid" src="{{ asset('webasset/images/product-12.jpg')}}" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
					...
					<div class="carousel-testimony owl-carousel">
						<div class="item">
							<div class="testimony-wrap p-4 pb-5">
								<div class="user-img mb-5" style="background-image: url({{ asset('webasset/images/p1.jpg')}})">
						...
						<div class="item">
							<div class="testimony-wrap p-4 pb-5">
								<div class="user-img mb-5" style="background-image: url({{ asset('webasset/images/p2.jpg')}})">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
									</span>
								</div>
						...
						<div class="item">
							<div class="testimony-wrap p-4 pb-5">
								<div class="user-img mb-5" style="background-image: url({{ asset('webasset/images/p3.jpg')}})">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
									</span>
								</div>
						...
						<div class="item">
							<div class="testimony-wrap p-4 pb-5">
								<div class="user-img mb-5" style="background-image: url({{ asset('webasset/images/p4.jpg')}})">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
									</span>
								</div>
						...
						<div class="item">
							<div class="testimony-wrap p-4 pb-5">
								<div class="user-img mb-5" style="background-image: url({{ asset('webasset/images/p5.jpg')}})">
									<span class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
									</span>
								</div>
	...
	<script src="{{ asset('webasset/js/jquery.easing.1.3.js')}}"></script>
	...
	<script src="{{ asset('webasset/js/bootstrap-datepicker.js')}}"></script>
	<script src="{{ asset('webasset/js/scrollax.min.js')}}"></script>

	<script src="{{ asset('webasset/js/google-map.js')}}"></script>
	<script src="{{ asset('webasset/js/main.js')}}"></script>


	<!--Start Gallery section -->
	<script src="{{ asset('webasset/js/gallery-jquery.min.js')}}"></script>
	<script src="{{ asset('webasset/js/gallery-jquery.flipster.min.js')}}"></script>
	<script>
            var coverflow = $("#coverflow").flipster();
	</script>
	<script src="{{ asset('webasset/js/jquery-2.1.4.min.js')}}"></script>
	<script src="{{ asset('webasset/js/bootstrap.min.js')}}"></script>
	<!-- End Gallery section -->
